...
const checks = [
  ...
  ["state-change gate ignores interrogative prompts (打开了个什么 is a question, not a directive)", (() => { const fn = functionSource("hasExplicitExecutionDirective"); return fn.includes("questionFollowUp") && fn.includes("[了个过一]{0,2}") && fn.indexOf("questionFollowUp") >= 0 && fn.indexOf("return true") > fn.indexOf("questionFollowUp"); })()],
