...
'@
    ...
    foreach ($field in @('mountedSuggestion','rotatesCandidates','rotationUsesSetting','rootDisplayedBeforePrefetch','manualStopsRotation','multilineComplete','inlineTextFlow','selectedMultiline','prefetchedImmediate','appliedExactly','autocompleteLayoutAligned','applyRestoredDocument','documentUntouched')) {
